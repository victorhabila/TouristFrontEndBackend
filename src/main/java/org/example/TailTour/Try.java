...
public class Try {
    ...
    private static ModelAndView home(spark.Request request, spark.Response response) {
        // Get the dwelling coordinates from the request parameters
        siteType= "Monument";
        ...
        // Calculate the closest monument
        GeographicPoint closestMonument = loaderGraph.closeMonument();
        // Calculate the shortest path
        List<GeographicPoint> shortesttPath= tt.aStarrSearch(dwellingPoint, points);
        // Prepare the data for the template
        Map<String, Object> model = new HashMap<>();
        model.put("dwellingLatitude", 48.40194444);
        model.put("dwellingLongitude", 2.698055556);
        model.put("closestMonument", closestMonument);
        ...
        public static void main(String[] args) {
            ...
            staticFiles.location("target/classes/templates/home.hbs"); // Serve static files from the "public" directory
                ...
                get("/", Try::home, new HandlebarsTemplateEngine());
